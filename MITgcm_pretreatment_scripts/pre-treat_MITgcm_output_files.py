PACKAGEDIRECTORY="/gpfs/scratch/userexternal/clauren1/LTRANS/RUN_SHAREMED/LTRANS_Zlev/"
#
writeUniformIniParlocFile=True  
(io,i_f,istep)=(0,0,10)
(jo,j_f,jstep)=(0,0,10)
#
MITgcmdirectory='/gpfs/scratch/userexternal/clauren1/LTRANS/MITgcm_CADEAU/'
f_Eta='Eta.'
f_RHOA='RHOAnoma.'
f_U='U.'
f_V='V.'
